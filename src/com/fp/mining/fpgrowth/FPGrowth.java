...
import com.fp.mining.eclat.Eclat;
import com.fp.util.DataIO;
  
public class FPGrowth extends HttpServlet{ 
     ...
     * @return 
     */
    public List<List<String>> readTransData(BufferedReader br) { 
     ...
     * @throws IOException 
     */
    public void printFreqPatterns(Map<List<String>, Integer> patterns, BufferedWriter bw, ArrayList<TreeNode> f1) throws IOException { 
        System.out.println(); 
        ...
        bw.append("MinSupport=" + this.getMinSup()+"\n");
        int total = patterns.size()+ f1.size();
        bw.append("Total number of Frequent Patterns is :" + total +"\n");
        bw.append("Frequent Patterns and their Support\n");
        //先输出频繁一项集及其支持度
        for(TreeNode tn : f1){
        	bw.append(tn.getName() + " : " + tn.getCount() +"\n"); 
        }
        Set<Entry<List<String>, Integer>> ss = patterns.entrySet(); 
        for (Entry<List<String>, Integer> entry : ss) { 
    ...
    public void doGet(HttpServletRequest req, HttpServletResponse res)
        ...
        //fptree.setMinSup(3); 
        List<List<String>> transRecords = fptree.readTransData(dataIO.read()); //第一组测试 
        ...
        fptree.setMinSup((int)(transRecords.size() * threshold));
        ...
        fptree.printFreqPatterns(patterns, dataIO.wirte(), F1); 
